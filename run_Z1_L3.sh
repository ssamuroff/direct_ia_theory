...
export DVNAME=
export CHAIN_NAME=nt_z${ZBIN}L${LBIN}_nla_${DVNAME}
...
cosmosis y6ia/y6ia-nla-slow.ini -p runtime.sampler=test output.lock=F -v intrinsic_alignment_parameters.a2=0. intrinsic_alignment_parameters.a1=1.0
